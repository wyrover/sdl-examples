...
public:
    ...
    virtual bool OnMoveWindow(int windowID, int x, int y)
    {
        return false;
    }
...
//  virtual bool OnClose(int windowID)                                      { return false; }
    ...
    // Key Events
    virtual bool OnKeyDown(SDL_Scancode scan, SDL_Keycode key)
    {
        return false;
    }

    virtual bool OnKeyUp(SDL_Scancode scan, SDL_Keycode key)
    {
        return false;
    }
    ...
    virtual bool OnMouseMove(int mX, int mY, int relX, int relY, bool Left, bool Right, bool Middle)
    {
        return false;
    }

    virtual bool OnMouseWheel(bool Up, bool Down)
    {
    ...
    virtual bool OnJoyAxis(Uint8 which, Uint8 axis, Sint16 value)
    {
        return false;
    }

    virtual bool OnJoyButtonDown(Uint8 which, Uint8 button)
    {
        return false;
    }

    virtual bool OnJoyButtonUp(Uint8 which, Uint8 button)
    {
        return false;
    }

    virtual bool OnJoyHat(Uint8 which, Uint8 hat, Uint8 value)
    {
        return false;
    }

    virtual bool OnJoyBall(Uint8 which, Uint8 ball, Sint16 xrel, Sint16 yrel)
    {
        return false;
    }
...
//  virtual bool OnExit()                                                       { return false; }
    ...
    virtual bool OnUser(Uint8 type, int code, void* data1, void* data2)
    {
        return false;
    }
};
