...
public:
    ...
    Vec2D& GetVel()
    {
        return const_cast<Vec2D&>(static_cast<const GameObject*>(this)->GetVel());
    }
    Vec2D& GetPos()
    {
        return const_cast<Vec2D&>(static_cast<const GameObject*>(this)->GetPos());
    }
    ...
    void SetAnchorPt(Vec2D anchorpt)
    {
        m_AnchorPt = anchorpt;
    }
