...
#endif
{
    ...
    player.LoadTexture(renderer, "sdl2-05/assets/player.png");
    player.ResetPosition(windowRect);
    background.LoadTexture(renderer, "sdl2-05/assets/background.png");
    bottomBar.LoadTexture(renderer, "sdl2-05/assets/bar.bmp");
    bottomBar.SetPos({ 0, windowRect.h - 20 });
    topBar.LoadTexture(renderer, "sdl2-05/assets/bar.bmp");
    AddEnemies(15);
    RunGame();
}
void RunGame()
...
void AddEnemy(int32_t height)
{
    ...
    enemy.LoadTexture(renderer, "sdl2-05/assets/enemy.png");
